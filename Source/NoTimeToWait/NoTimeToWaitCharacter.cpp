...
ANoTimeToWaitCharacter::ANoTimeToWaitCharacter()
{
	...
	GetCharacterMovement()->RotationRate = FRotator(0.0f, 640, 0.0f); // ...at this rotation rate
...
void ANoTimeToWaitCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ANoTimeToWaitCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ANoTimeToWaitCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
